function find_steps_spt
%click near a trajectory and run AutoStepFinder on it.
...
ud.cell.track{ind_minr}.stepfit.window = wdw;
ud.cell.track{ind_minr}.stepfit.fit_result = fit_result;
ud.cell.track{ind_minr}.stepfit.step_output = step_out;
ud.cell.track{ind_minr}.stepfit.s_curve = s_curve;
